            ...
            <div className="container max-w-screen-xl mx-auto px-4">
                <div className="flex flex-col xl:flex-row xl:justify-between gap-y-8 xl:gap-x-8">
                    ...
                    <div className="flex flex-col justify-center mx-auto xl:mx-0 text-center xl:text-left" >
                        <div className="text-sm uppercase font-semibold mb-4 text-primary tracking-[2px]" data-aos="fade-down">Hi there👋, my name is</div>
                        <h1 className='h1 mb-4' data-aos="fade-right">Satria Ahmad Gilvan</h1>
                        {/* Typing Animation */}
                        <div className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 whitespace-nowrap" data-aos="fade-right">
                            <span>I'm a <TypingAnimation texts={texts} speed={100} eraseSpeed={50} delay={1500} />
                            </span>
                        </div>
                        <p className='subtitle max-w-[490px] mx-auto xl:mx-0' data-aos="fade-up">
                            I am passionate about technology and dedicated to advancing my skills in computer science.
                        </p>
                        {/* button */}
                        <div className="flex flex-col gap-y-3 md:flex-row gap-x-3 mx-auto xl:mx-0 mb-12" data-aos="zoom-in">
                            <Link href='/contact'>
                        ...
                        {/* socials */}
                        <Socials containerStyles='flex gap-x-6 mx-auto xl:mx-0' iconsStyles='text-foreground text-[22px] hover:text-primary transition-all' data-aos="fade-up"/>
                    </div>

                    {/* {image} */}
                    <div className="hidden xl:flex relative bottom-6" data-aos="fade-left">
                        {/* badge 1 */}
