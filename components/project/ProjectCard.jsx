...
const ProjectCard = ({ project }) => {
  ...
  return (
    <div className="relative mt-6">
      <Badge className="absolute -top-3 left-4 z-20 uppercase text-sm font-medium">
        {project.category}
      </Badge>

      <Card className="group overflow-hidden border border-transparent hover:border-primary transition">
            ...
            <Dialog>
              <DialogTrigger asChild>
                <Button
                  size="sm"
                  variant="outline"
                  className="group gap-1 bg-primary hover:bg-primary/90 text-white dark:text-black"
                >
              ...
              <DialogContent className="z-[100] max-w-2xl bg-background/90 max-h-[100vh] overflow-y-auto custom-scrollbar">
                <DialogHeader>
