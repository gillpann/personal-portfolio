    ...
    return (
        <section className="relative mb-12 xl:mb-48">
            <div className="container mx-auto">
                {/* text */}
                <div className="max-w-[400px] mx-auto xl:mx-0 text-center xl:text-left mb-12 xl:h-[400px] flex flex-col justify-center items-center xl:items-start mt-10" data-aos="fade-right">
                ...
                {/* slider */}
                <div className="xl:max-w-[800px] xl:absolute right-0 top-0" data-aos="fade-left">
